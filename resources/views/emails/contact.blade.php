...
<body class="bg-red-100">
    <div class="container">
        <div class="card rounded-3xl px-4 py-8 p-lg-10 mb-6">
            <h3 class="text-center">Reception de la part de {{ $details['nom_prenom'] }}</h3>
            <table class="p-2 w-full">
                <tbody>
                    <tr>
                        <td>Email</td>
                        <td class="text-right">{{ $details['email'] }}</td>
                    </tr>
                    <tr>
                        <td>Telephone</td>
                    ...
                    <tr>
                        <td class="fw-700 border-top">Message</td>
                        <td class="fw-700 text-right border-top">{{ $details['message'] }}</td>
                    </tr>
                </tbody>
            </table>
            <hr class="my-6">
