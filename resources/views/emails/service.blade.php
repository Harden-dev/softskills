...
<head>
    ...
    <title>Service Mail</title>
</head>

<body class="bg-red-100">
    <div class="container">
        <div class="card rounded-3xl px-4 py-8 p-lg-10 mb-6">
            <h3 class="text-center">Reception de la part de {{ $serviceDetails['nom_prenom'] }}</h3>
            <table class="p-2 w-full">
                <tbody>
                    <tr>
                        <td>Email</td>
                        <td class="text-right">{{ $serviceDetails['email'] }}</td>
                    </tr>
                    <tr>
                        <td>Contact</td>
                        <td class="text-right">{{ $serviceDetails['contact'] }}</td>
                    </tr>
                    <tr>
                        <td class="fw-700 border-top">Type de service</td>
                        <td class="fw-700 text-right border-top">{{ $serviceDetails['type_services'] }}</td>
                    </tr>
                </tbody>
            </table>
            <hr class="my-6">
